...
?>
        ...
        <form name="items" action="index.php" method="post">
            <table>
                ...
                <tr>
                    <td>Product Code</td>
                    <td><input type="text" name="PSProductCode" value="<?php echo $product->PSProductCode; ?>" required></td>
                </tr>
                <tr>
                    <td>Name</td>
                    <td><input type="text" name="PSProductName" value="<?php echo $product->PSProductName; ?>" required></td>
                </tr>
                <tr>
                    <td>Description</td>
                    <td><textarea name="PSdescription" required><?php echo $product->PSdescription; ?></textarea></td>
                </tr>
                <tr>
                    <td>Aisle Number</td>
                    <td><input type="text" name="PSAisle_Number" value="<?php echo $product->PSAisle_Number; ?>" required></td>
                </tr>
                <tr>
                    <td>Category ID</td>
                    <td><input type="text" name="PSCategoryID" value="<?php echo $product->PSCategoryID; ?>" required></td>
                </tr>
                <tr>
                    <td>Wholesale Price</td>
                    <td><input type="text" name="PSWholesalePrice" value="<?php echo $product->PSWholesalePrice; ?>" required></td>
                </tr>
                <tr>
                    <td>List Price</td>
                    <td><input type="text" name="PSListPrice" value="<?php echo $product->PSListPrice; ?>" required></td>
                </tr>
            </table><br><br>
